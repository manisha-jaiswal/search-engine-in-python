...
def mathingWords(sentence1, sentence2):
    ...
    score = 0
    for word1 in words1:
        for word2 in words2: #hr word1 ke liye wrd2 me enter kro
            # print(f"Matching {word1} with {word2}")
            if word1.lower() == word2.lower():#sv ko lower me change krk match kro
                score += 1
    return score

if __name__ == "__main__":
    # mathingWords("This is good", "python is good")
    sentences = ["python is a good language", "this is snake",
                 "harish is a good boy", "Subscribe me","manisha is a good girl"]
